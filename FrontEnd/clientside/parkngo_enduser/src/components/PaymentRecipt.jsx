...
export default function PaymentRecipt(props) {
  ...
  return (
    ...
    >
      ...
      <div className="my-3">
        <span
          className="col-md-4 text-success mx-2"
      ...
      <div className="form-groups d-flex justify-content-center">
        <div className="mx-3">
          ...
          <input
            type="text"
            className="form-control col-lg bg-primary text-center text-white"
      ...
      <div className="border-bottom py-4">
        <span className="text-success" style={{ fontSize: "3em" }}>
          Paid : ₹ {amountPaid}
        </span>
        <span
      ...
      <span className="text-body-primary d-block mt-3">
